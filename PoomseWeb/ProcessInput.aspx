<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProcessInput.aspx.vb" Inherits="PoomseWeb.ProcessInput" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var txtAcc = $("#<%=lblAcc.ClientID %>");
            var txtPre = $("#<%=lblPre.ClientID %>");
            ...
            $("#btnConfirm").click(
                ...
                function() {
                    ...
                    if (window.confirm("Do you want to confirm?") == true) {
						...
						$.ajax({
							type: "POST",
							url: "confirm.aspx?Judge=" + jude + "&Acc=" + Acc + "&Pre=" + Pre,
							data: '{Jude:"' + jude + '",Acc:' + Acc + ',Pre:' + Pre + '}',
        ...
        <table>
            ...
            <tr>
                <td style="background-color: #0000FF; color: #FFFF00; text-align: center;" class="style6">
                    <asp:Label ID="lblAcc" runat="server" Text="4.0" Font-Size="40pt" ForeColor="Gold"></asp:Label>
                </td>
                <td class="style8">
                </td>
                <td style="text-align: center; background-color: #FF0000;" class="style7">
                    <asp:Label ID="lblPre" runat="server" Text="6.0" Font-Size="40pt" ForeColor="Gold"></asp:Label>
                </td>
            </tr>
            <tr style="height: 3px">
                <td colspan="3">
